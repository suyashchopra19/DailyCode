...
var _JSXComment2 = _interopRequireDefault(_JSXComment);
...
exports.default = {
  HTMLElement: {
    enter(path) {
      const jsxElement = new _JSXElement2.default();
  ...
  HTMLAttribute: {
    enter(path) {
      const jsxAttribute = new _JSXAttribute2.default();
      jsxAttribute.name = getAttributeName(path.node, path.parent);
      jsxAttribute.value = getAttributeValue(path.node);
      jsxAttribute.litteral = (0, _util.isNumeric)(jsxAttribute.value);
      path.replace(jsxAttribute);
    }
  },
  HTMLComment: {
    enter(path) {
      const jsxComment = new _JSXComment2.default();
  ...
  HTMLText: {
    enter(path) {
      const jsxText = new _JSXText2.default();
