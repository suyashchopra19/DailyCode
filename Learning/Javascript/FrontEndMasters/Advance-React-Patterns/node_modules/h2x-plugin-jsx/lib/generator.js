...
var _stringToObjectStyle = require('./stringToObjectStyle');

var _stringToObjectStyle2 = _interopRequireDefault(_stringToObjectStyle);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const formatAttribute = jsxAttribute => {
  if (jsxAttribute.spread) return `{...${jsxAttribute.name}}`;
  if (jsxAttribute.litteral) return `${jsxAttribute.name}={${jsxAttribute.value}}`;
  if (jsxAttribute.name === 'style') return `${jsxAttribute.name}={${JSON.stringify((0, _stringToObjectStyle2.default)(jsxAttribute.value))}}`;
